            ...
            Expanded(
              child: Container(
                ...
                MaterialButton(
                  ...
                  child: Text('Check out ',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 22,),textAlign: TextAlign.center,),
                  color: Colors.green,
                ),),
                color: Colors.green,
              ),
                                    ...
                                    Expanded(child: InkWell(
                                      ...
                                      onTap: () {
                                        setState(() {
                                          ...
                                          widget.attributeMap[index]['picture'];
                                          map['price'] =
                                          widget.attributeMap[index]['price'];
                                          map['quantity'] =
                                          '1';
                                          map['id'] = widget.attributeMap[index]['id'];
                                    ...
                                    Expanded(child: InkWell(
                                      ...
                                      onTap: () async {
                                        setState(() {
                                          ...
                                          Provider.of<addCart>(context,listen: false ).deleteData(widget.attributeMap[index]['id']);
