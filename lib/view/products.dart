...
import 'package:ecommerceapp/model/MyData.dart';
...
class _prodcutsState extends State<prodcuts> {
  ...
  Future getProductData() async {
    ...
    if (produc_list2.length != 0) produc_list = produc_list2;
    setState(() {});
  }
}
...
class every_product extends StatelessWidget {
  ...
  every_product(
      this.prodcut_id,
      this.prodcut_name,
      this.prodcut_picture,
      this.prodcut_oldprice,
      this.prodcut_price,
      this.prodcut_detials,
      this.loginUserId);
